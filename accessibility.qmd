...
In addition, I'll document the failures and any corrective actions as issues in the [GitHub repository](https://github.com/ramirobarrantes/website/issues) housing the files used to build this site.
